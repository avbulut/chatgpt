...
document.getElementById('login').onclick = function() {
    ...
    .then(data => {
        ...
        firebase.database().ref("users/").orderByChild("ip").equalTo(ipAddress).once("value", snapshot => {
...
firebase.database().ref("chats/").on("child_added", async function(snapshot) {
  ...
  const lastVisit = await  firebase.database().ref("users/").orderByChild("ip").equalTo(ipAddress).once("value");
